...
module.exports = function(src) {
  ...
  x.get('/pending', (req, res, next) => src.pendingInsert(req.body).then((ans) => res.json(1), next));
  x.delete('/pending/:id', (req, res, next) => src.pendingDeleteOne(req.body).then((ans) => res.json(1), next));
  return x;
};
