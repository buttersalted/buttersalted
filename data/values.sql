...
SELECT type_insertoneifnotexists('Starch', 'REAL');
...
SELECT type_insertoneifnotexists('Tridecanoic acid', 'REAL');
...
SELECT type_insertoneifnotexists('Uncosapentaenoic acid', 'REAL');
...
SELECT term_insertoneifnotexists('13:0', 'Tridecanoic acid');
...
SELECT term_insertoneifnotexists('21:5', 'Uncosapentaenoic acid');
